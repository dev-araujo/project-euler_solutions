...
function largestProductinaSeries(n) {
  ...
  for (let num = 0; num <= thousandDigits.length - n; num++) {
    let window = thousandDigits.slice(num, num + n);
    let currentProduct = window.reduce((a, b) => a * b);
...
console.log(largestProductinaSeries(4)); // should return 5832
console.log(largestProductinaSeries(13)); // should return 23514624000
